...
<div class="pageheader">
  <h2><i class="fa fa-table"></i>January Worksheet<span></span></h2>
  <div class="breadcrumb-wrapper">
    <span class="label">You are here:</span>
    <ol class="breadcrumb">
      <li><a href="<?php echo base_url();?>index.php/january_worksheet">January Worksheet</a></li>
      <li class="active">Add January Worksheet Entry</li>
  </ol>
</div>
</div>
...
<div class="contentpanel">
 ...
 <div class="panel-body panel-body-nopadding">
      ...
      <!-- content goes here... -->
      <!--Monthly Details form-->
      <!--<form id="form2" class="form-horizontal form-bordered">-->
      <?php echo form_open('january_worksheet/insert_january_worksheet_info', array('class' => 'form-horizontal', 'enctype' => 'multipart/form-data')); ?>
            <div class="panel panel-default">
              <div class="panel-heading">
                <div class="panel-btns">
                  <a href="#" class="panel-close">&times;</a>
                ...
                <h4 class="panel-title">Monthly Details</h4>
              ...
              <div class="panel-body panel-body-nopadding">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <select class="form-control mb15" name="bus_reg_jan" placeholder="Bus Registration">
                  ...
                  <?php echo form_error('bus_reg_jan');?>
                </div>
                  <!--Bus Registration-->
                <div class="form-group">
                  <label class="col-sm-4 control-label">Staff Operation ID</label>
                  <div class="col-sm-8">
                    <select class="form-control mb15" name="staff_operationid_jan" placeholder="Bus Registration">
                  ...
                  <?php echo form_error('staff_operationid_jan');?>
                </div>
               </div><!-- panel-body -->

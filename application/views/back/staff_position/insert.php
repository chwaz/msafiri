...
<div class="pageheader">
  ...
  <div class="breadcrumb-wrapper">  
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Add Staff Position log</li>
  </ol>
</div>
</div>
...
<div class="contentpanel">
 ...
 <div class="panel-body panel-body-nopadding">
      ...
      <?php echo form_open('staff_position/insert_staff_position_info', array('class' => 'form-horizontal', 'enctype' => 'multipart/form-data')); ?>
            <div class="panel panel-default">
              <div class="panel-heading">
                <div class="panel-btns">
                  <a href="#" class="panel-close">&times;</a>
              ...
              <div class="panel-body panel-body-nopadding">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input class="form-control" name="position_title" />
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input class="form-control" name="position_description" />
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input class="form-control" name="position_salaryclass" />
                  </div>

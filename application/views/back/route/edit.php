...
<div class="contentpanel">
 ...
 <div class="panel-body panel-body-nopadding">
      ...
      <?php echo form_open('route/update_route_info/'$r->route_detailsid, array('class' => 'form-horizontal', 'enctype' => 'multipart/form-data')); ?>
            <div class="panel panel-default">
              <div class="panel-heading">
                <div class="panel-btns">
                  <a href="#" class="panel-close">&times;</a>
              ...
              <div class="panel-body panel-body-nopadding">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="route_number" class="form-control" value="<?php echo $r->route_number; ?>"/>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" id="lastrenewaldate" name="route_name" class="form-control" value="<?php echo $r->route_name; ?>"/>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" id="nextrenewaldate" name="route_county" class="form-control" value="<?php echo $r->route_county; ?>"/>
                  </div>

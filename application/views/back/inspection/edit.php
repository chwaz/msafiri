...
<div class="contentpanel">
 ...
 <div class="panel-body panel-body-nopadding">
      ...
      <?php echo form_open('inspection/update_inspection_info/'.$r->inspection_detailsid, array('class' => 'form-horizontal', 'enctype' => 'multipart/form-data')); ?>
            <div class="panel panel-default">
              <div class="panel-heading">
                <div class="panel-btns">
                  <a href="#" class="panel-close">&times;</a>
              ...
              <div class="panel-body panel-body-nopadding">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="inspector_id" class="form-control" value="<?php echo $r->inspector_id;?>"/>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="inspector_fname" class="form-control" value="<?php echo $r->inspector_fname;?>"/>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="inspector_lname" class="form-control" value="<?php echo $r->inspector_lname;?>"/>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" id="lastexpirydate" name="last_check" class="form-control" value="<?php echo $r->last_check;?>"/>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" id="nextexpirydate" name="next_check" class="form-control" value="<?php echo $r->next_check;?>"/>
                  </div>

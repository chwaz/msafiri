...
<div class="contentpanel">
 ...
 <div class="panel-body panel-body-nopadding">
      ...
      <?php echo form_open('insurance/insert_insurance_info', array('class' => 'form-horizontal', 'enctype' => 'multipart/form-data')); ?>
            <div class="panel panel-default">
              <div class="panel-heading">
                <div class="panel-btns">
                  <a href="#" class="panel-close">&times;</a>
              ...
              <div class="panel-body panel-body-nopadding">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="insurance_phoneno" class="form-control" />
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="insurance_email" class="form-control" />
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="insurance_website" class="form-control" />
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <textarea name="insurance_location" class="form-control"></textarea>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <textarea name="insurance_address" class="form-control"></textarea>
                  </div>
                  <?php echo form_error('insurance_website');?>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" id="lastrenewaldate" name="last_renewal" class="form-control" />
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" id="nextrenewaldate" name="next_renewal" class="form-control" />
                  </div>

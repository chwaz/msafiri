      ...
      <?php echo form_open('buses/insert_bus_info', array('class' => 'form-horizontal', 'enctype' => 'multipart/form-data')); ?>
            <div class="panel panel-default">
              ...
              <div class="panel-body panel-body-nopadding">
                ...
                <!--Builder info-->
                <div class="form-group">
                  <label class="col-sm-4 control-label">Body Builder/Fabricator</label>
                  <div class="col-sm-8">
                    <select class="form-control mb15" name="body_builderid2" placeholder="Body Builder/Fabricator">
                        <option value="" disabled selected>Select Builder/Fabricator</option>
                      <?php foreach($builders as $row){ 

                         echo '<option value="'.$row->body_builderid.'">'.$row->abbreviations.'</option>';
                      }
                      ?>
                    </select>
                </div>
                  <?php echo form_error('body_builderid2');?>
                </div>
                <!--IDno-->
                <div class="form-group">
                  <label class="col-sm-4 control-label">Owner Identification</label>
                  <div class="col-sm-8">
                    <select class="form-control mb15" name="idno" placeholder="Owner Identification">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <select class="form-control mb15" id="" name="no_of_seats">
                      <option value="" disabled selected>Select your option</option>

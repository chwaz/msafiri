...
<div class="contentpanel">
 ...
 <div class="panel-body panel-body-nopadding">
      ...
      <?php echo form_open('staff/update_staff_info', array('class' => 'form-horizontal', 'enctype' => 'multipart/form-data')); ?>
            <div class="panel panel-default">
              <div class="panel-heading">
                <div class="panel-btns">
                  <a href="#" class="panel-close">&times;</a>
              ...
              <div class="panel-body panel-body-nopadding">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="kra_pino" class="form-control" value="<?php echo $r->kra_pino;?>"/>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="heath_insuranceno" class="form-control" value="<?php echo $r->health_insuranceno;?>"/>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="kin_firstname" class="form-control" value="<?php echo $r->kin_firstname;?>"/>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="kin_lastname" class="form-control" value="<?php echo $r->kin_lastname;?>"/>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="kin_middlename" class="form-control" value="<?php echo $r->kin_middlename;?>"/>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="kin_idno" class="form-control" value="<?php echo $r->kin_idno;?>"/>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="kin_phoneno" class="form-control" value="<?php echo $r->kin_phoneno;?>"/>
                  </div>

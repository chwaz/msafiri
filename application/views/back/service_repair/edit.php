...
<div class="contentpanel">
 ...
 <div class="panel-body panel-body-nopadding">
      ...
      <?php echo form_open('service_repair/update_service_repair_info/'.$r->service_repairid, array('class' => 'form-horizontal', 'enctype' => 'multipart/form-data')); ?>
            <div class="panel panel-default">
              <div class="panel-heading">
                <div class="panel-btns">
                  <a href="#" class="panel-close">&times;</a>
              ...
              <div class="panel-body panel-body-nopadding">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input class="form-control" name="total_cost" value="<?php echo $r->total_cost; ?>"/>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input class="form-control" id="previouscheckdate" name="date_of_previous" value="<?php echo $r->date_of_previous; ?>"/>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input class="form-control" id="nextcheckdate" name="date_of_next" value="<?php echo $r->date_of_next; ?>"/>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <textarea class="form-control" name="garage_name" ><?php echo $r->garage_name; ?></textarea>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <textarea class="form-control" name="garage_location" ><?php echo $r->garage_location; ?></textarea>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <textarea class="form-control" name="garage_contact" ><?php echo $r->garage_contact; ?></textarea>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <textarea class="form-control" name="garage_address" ><?php echo $r->garage_address; ?></textarea>
                  </div>

...
<div class="pageheader">
  <h2><i class="fa fa-table"></i>February Worksheet<span></span></h2>
  <div class="breadcrumb-wrapper">
    <span class="label">You are here:</span>
    <ol class="breadcrumb">
      <li><a href="<?php echo base_url();?>index.php/february_worksheet">February Worksheet</a></li>
      <li class="active">Add February Worksheet Entry</li>
  </ol>
</div>
</div>
...
<div class="contentpanel">
 ...
 <div class="panel-body panel-body-nopadding">
      ...
      <?php echo form_open('february_worksheet/insert_february_worksheet_info', array('class' => 'form-horizontal', 'enctype' => 'multipart/form-data')); ?>
            <div class="panel panel-default">
              <div class="panel-heading">
                <div class="panel-btns">
                  <a href="#" class="panel-close">&times;</a>
              ...
              <div class="panel-body panel-body-nopadding">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <select class="form-control mb15" name="bus_reg_feb" placeholder="Bus Registration">
                  ...
                  <?php echo form_error('bus_reg_feb');?>
                </div>
                  <!--Bus Registration-->
                <div class="form-group">
                  <label class="col-sm-4 control-label">Staff Operation ID</label>
                  <div class="col-sm-8">
                    <select class="form-control mb15" name="staff_operationid_feb" placeholder="Bus Registration">
                  ...
                  <?php echo form_error('staff_operationid_feb');?>
                </div>
               </div><!-- panel-body -->

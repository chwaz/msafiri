...
<div class="pageheader">
  <h2><i class="fa fa-table"></i>May Worksheet<span></span></h2>
  <div class="breadcrumb-wrapper">
    <span class="label">You are here:</span>
    <ol class="breadcrumb">
      <li><a href="<?php echo base_url();?>index.php/may_worksheet">May Worksheet</a></li>
      <li class="active">Add May Worksheet Entry</li>
  </ol>
</div>
</div>
...
<div class="contentpanel">
 ...
 <div class="panel-body panel-body-nopadding">
      ...
      <?php echo form_open('may_worksheet/insert_may_worksheet_info', array('class' => 'form-horizontal', 'enctype' => 'multipart/form-data')); ?>
            <div class="panel panel-default">
              <div class="panel-heading">
                <div class="panel-btns">
                  <a href="#" class="panel-close">&times;</a>
              ...
              <div class="panel-body panel-body-nopadding">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <select class="form-control mb15" name="bus_reg_may" placeholder="Bus Registration">
                  ...
                  <?php echo form_error('bus_reg_may');?>
                </div>
                  <!--Bus Registration-->
                <div class="form-group">
                  <label class="col-sm-4 control-label">Staff Operation ID</label>
                  <div class="col-sm-8">
                    <select class="form-control mb15" name="staff_operationid_may" placeholder="Bus Registration">
                  ...
                  <?php echo form_error('staff_operationid_may');?>
                </div>
               </div><!-- panel-body -->
